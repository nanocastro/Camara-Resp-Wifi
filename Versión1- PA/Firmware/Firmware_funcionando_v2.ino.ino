...
#define HIGH_RES_COUNT 450 // was 150
...
*/
    if (meas_counter > 0) {
        display.drawLine(meas_counter - 0 + 28, 64 - 400 / displayFactor, meas_counter + 28, 64 - current->ppm / displayFactor, WHITE);
    }
...
void OLEDdrawBackground()
{
    ...
    for (int i = 28; i <= 128; i = i + 5) {
        display.drawPixel(i, 64 - (900 / displayFactor), WHITE);
    }
    /*
    ...
    */
    ...
    display.println("CO2 Respiration");
    if (buttonPressed) display.drawBitmap(0, 0, humus_logo_plant, 128, 64, WHITE);
    display.display();
}
